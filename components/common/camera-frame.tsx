  ...
  return (
    <div className="box-border relative w-full h-full">
      ...
      <div className="fixed z-50 w-full h-full p-4 pointer-events-none ">
        <FrameLineLT className="w-[120px] h-[100px] sm:w-[180px]:h-[150px] max-sm:top-1 max-sm:left-1 absolute top-4 left-4" />
        <FrameLineLB className="w-[120px] h-[100px] sm:w-[180px]:h-[150px] max-sm:bottom-1 max-sm:left-1 absolute bottom-4 left-4" />
        <FrameLineRT className="w-[120px] h-[100px] sm:w-[180px]:h-[150px] max-sm:top-1 max-sm:right-1 absolute top-4 right-4" />
        <FrameLineRB className="w-[120px] h-[100px] sm:w-[180px]:h-[150px] max-sm:bottom-1 max-sm:right-1 absolute bottom-4 right-4" />
      </div>
      ...
      <ScrollIndicator className="fixed z-50 bottom-2 max-sm:bottom-0 left-[50%] ml-[-136px] w-[273px] max-sm:w-[120px] max-sm:ml-[-60px] " />
